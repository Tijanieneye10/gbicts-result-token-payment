        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title" style="background-image: url({{ asset('logins/images/bg-01.jpg') }});">
                    ...
                    <p style="color:white">This is a secure area of the application. Please confirm your password before continuing</p>
                </div>
                ...
                <form action="{{ route('password.confirm') }}" method="POST" class="login100-form validate-form">
                    @csrf
